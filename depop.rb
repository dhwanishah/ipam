...
(2...10).each{|n|
    STDOUT.write(gen_redis_proto("DEL","192.168.1.#{n}",":ipaddress => \"192.168.1.#{n}\", :subnet => \"255.255.255.0\", :gateway => \"192.168.1.1\", :nameserver => \"3.3.3.3\", :allocated => \"false\", :score => 0"))
}
